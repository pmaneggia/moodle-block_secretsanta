...
/**
 * PHP side implementation of the actions (draw and reset).
 *
...
$site = get_site();
$PAGE->set_url('/blocks/secretsanta/action_draw.php', array('courseid' => $courseid));
$heading = $site->fullname . ' :: ' . $course->shortname . ' :: reset';
$PAGE->set_heading($heading);
$PAGE->set_title('Secret Santa draw');
$PAGE->set_secondary_navigation(false);

if (!$confirm) {
    $optionsno = new moodle_url('/course/view.php', array('id' => $courseid));
    $optionsyes = new moodle_url('/blocks/secretsanta/action_draw.php', array('courseid' => $courseid, 'confirm' => 1, 'sesskey' => sesskey()));
